...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/cw/css/main.css?v=0002" />
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/cw/js/wechat.js?v=001"></script>
