...
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/fws3/css/main.css?v=006" />
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/fws3/js/Draggable.min.js"></script>
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/fws3/js/wechat_message.js?v=01"></script>
